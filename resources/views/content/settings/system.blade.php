    ...
    <div class="row">
        <div class="col-lg-12 col-xxl-12 mb-4 order-3 order-xxl-1">
            <div class="card-header mb-4 d-flex">
                ...
                <a href="{{ url('/settings/system') }}" class="agent-status-active text-center mx-2 acitive-tab">
                                    ...
                                    <form action="" data-os-action="updates__save_license_information"
                                            ...
                                            <div class="os-col-lg-6">
                                                <div
                                                    ...
                                                    <label for="license_full_name">Your Name</label><input type="text"
                                                        ...
                                                        id="license_full_name" class="os-form-control"></div>
                                            </div>
                                            <div class="os-col-lg-6">
                                                <div
                                                    class="os-form-group os-form-textfield-group os-form-group-transparent">
                                                    <label for="license_email">Your Email Address</label><input
                                                        type="text" placeholder="Your Email Address"
                                                        name="license[email]" value="" id="license_email"
                                        ...
                                        <div class="os-row">
                                            <div class="os-col-12">
                                                <div
                                                    class="os-form-group os-form-textfield-group os-form-group-transparent">
                                                    <label for="license_license_key">License Key</label><input
                                                        type="text" placeholder="License Key" name="license[license_key]"
                                                        value="" id="license_license_key" class="os-form-control">
                                                </div>
                                            </div>
                                        </div>
