    ...
    <div class="row">
        <div class="col-lg-12 col-xxl-12 mb-4 order-3 order-xxl-1">
            <div class="card-header mb-4 d-flex">
                <a href="{{ url('/settings/processes') }}" class="agent-status-active text-center mx-2 acitive-tab">
                ...
                <a href="{{ url('/settings/activities') }}" class="agent-status-active text-center mx-2">
                                ...
                                <div class="os-form-block-params os-form-w">
                                        ...
                                        <div class="sub-section-row">
                                            ...
                                            <div class="sub-section-content">
                                                <div class="os-form-group os-form-toggler-group  size-normal process_event_conditional">
                                                    <input type="hidden" name="process[event][conditional]" value="{{htmlspecialchars($value['event']['conditional'])}}"
                                                        id="process_event_conditional">
                                                    <div data-controlled-toggle-id="pe-conditions-for-pe_ZuOF5X"
                                                        class="os-toggler size-normal {{htmlspecialchars($value['event']['conditional'])}}" data-is-string-value="true"
                                                ...
                                                <div class="pe-conditions" id="pe-conditions-for-pe_ZuOF5X" style="<?php echo htmlspecialchars($value['event']['conditional']) === 'on' ? '' : 'display:none;' ?>">
                                                    ...
                                                    <div class="pe-condition" data-condition-id="{{$key}}"><button
                                                        ...
                                                        <div class="process-condition-properties-w">
                                                            <div class="os-form-group os-form-select-group os-form-group-transparent">
                                                                <select name="process[event][trigger_conditions][{{$key}}][property]"
                                                        ...
                                                        <div class="process-condition-operators-w">
                                                            <div class="os-form-group os-form-select-group os-form-group-transparent">
                                                                <select name="process[event][trigger_conditions][{{$key}}][operator]"
                                                                    ...
                                                                    <option value="equal" <?php echo ($item['operator']) == "equal" ? 'selected' : ''; ?>>is equal to</option>
                                                                    <option value="not_equal" <?php echo ($item['operator']) == "not_equal" ? 'selected' : ''; ?>>is not equal to</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                        <div class="process-condition-values-w" style="">
                                                            <div class="os-form-group os-form-select-group os-form-group-transparent">
                                                                <div class="lateselect-w">
                                                                    ...
                                                                    name="process[event][trigger_conditions][{{$key}}][value]" value="">
                                                            </div>
                                                        </div>
                                    ...
                                    <div class="sub-section-row">
                                        ...
                                        <div class="sub-section-content">
                                            <div class="os-form-group os-form-toggler-group  size-normal process_event_has_time_offset"><input
                                                    type="hidden" name="process[event][has_time_offset]" value="{{$value['event']['has_time_offset']}}"
                                                    id="process_event_has_time_offset">
                                                <div data-controlled-toggle-id="pe-conditions-for-pe_C0UjnF" class="os-toggler size-normal {{$value['event']['has_time_offset']}}"
                                            ...
                                            <div class="pe-conditions" id="pe-conditions-for-pe_C0UjnF" style="<?php echo htmlspecialchars($value['event']['has_time_offset']) === 'on' ? '' : 'display:none;' ?>">
                                                <div class="time-offset-actions">
                                                    ...
                                                    <div
                                                        ...
                                                        <input type="number" placeholder="" name="process[event][time_offset][value]" value="{{$value['event']['time_offset']['value']}}"
                                    ...
                                    <div class="sub-section-row">
                                        ...
                                        <div class="sub-section-content">
                                            ...
                                            <div class="process-action-form pa-type-send_email pa-status-active" data-id="pa_NF3Iic">
                                                    ...
                                                    <div class="os-row">
                                                        <div class="os-col-10">
                                                            <div class="os-form-group os-form-select-group os-form-group-transparent"><label
                                                                    ...
                                                                    <option value="send_email" <?php echo $item['type'] == "send_email" ? 'selected' : ''; ?>>Send Email</option>
                                                                    <option value="send_sms" <?php echo $item['type'] == "send_sms" ? 'selected' : ''; ?>>Send SMS</option>
                                                                    <option value="trigger_webhook" <?php echo $item['type'] == "trigger_webhook" ? 'selected' : ''; ?>>HTTP Request</option>
                                                                </select></div>
                                                        </div>
                                                        <div class="os-col-2">
                                                            <div class="os-form-group os-form-select-group os-form-group-transparent"><label
                                                        ...
                                                        <div class="os-row">
                                                            <div class="os-col-6">
                                                                <div class="os-form-group os-form-textfield-group os-form-group-simple"><label
                                                                        ...
                                                                        name="process[actions][{{$key}}][settings][to_email]" value="{{$item['settings']['to_email']}}"
                                                            ...
                                                            <div class="os-col-6">
                                                                <div class="os-form-group os-form-textfield-group os-form-group-simple"><label
                                                                        ...
                                                                        name="process[actions][{{$key}}][settings][subject]" value="{{$item['settings']['subject']}}"
                                    ...
                                    <div class="os-form-block-buttons">
                                        ...
                                        <button type="submit" class="os-form-block-save-btn latepoint-btn latepoint-btn-primary"><span>Update
                                                Process</span></button>
                                    </div>
                                </div>
                            </div>
