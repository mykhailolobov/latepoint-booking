...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12 col-xxl-12 mb-4 order-3 order-xxl-1">
            ...
            <div class="col-md-12">
                <input type="hidden" class="form-control" placeholder="YYYY-MM-DD" id="flatpickr-range" style="display: none"/>
                                            ...
                                            <th>
                                                <div
                                                    ...
                                                    <input type="text" placeholder="User ID"
                                                        name="filter[initiated_by_id]" value=""
                                                        class="os-table-filter os-form-control" id="filter_initiated_by_id">
                                                </div>
                                            </th>
                                            <th>
                                                <div class="os-form-group">
                                                    ...
                                                    <input type="text" id="bs-rangepicker-basic"
                                                        placeholder="Filter By Date" class="form-control" style="height: 26px"/>
