            ...
            <div class="col-md-12">
                <div class="latepoint-content ">
                    ...
                    <div class="os-default-roles-w mb-4 os-form-blocks-w">
                        <form action="{{route('settings-storeroles')}}" method="post" data-os-action="roles__save" class="os-form-block os-user-type-form ">
                            @csrf
                        ...
                        @else
                        <form action="{{route('settings-updateroles', $latepoint->id)}}" method="post" data-os-action="roles__save" class="os-form-block os-user-type-form ">
                            @csrf
                            @php
                                            ...
                                            <div class="role-actions-grid">
                                                <div class="role-actions-item">
                                                    ...
                                                    <div class="role-toggler-wrapper">
                                                        <div class="os-form-group os-form-toggler-group  size-normal">
                                                            <input type="hidden" name="role[capabilities][agent__view]"
                                                                value="{{$lpvalue['agent__view']}}" id="role_capabilities_agent_view">
                                                    ...
                                                    <div class="role-toggler-wrapper">
                                                        <div class="os-form-group os-form-toggler-group  size-normal">
                                                            <input type="hidden" name="role[capabilities][agent__delete]"
                                                                value="{{$lpvalue['agent__delete']}}" id="role_capabilities_agent_delete">
                                                    ...
                                                    <div class="role-toggler-wrapper">
                                                        <div class="os-form-group os-form-toggler-group  size-normal">
                                                            <input type="hidden" name="role[capabilities][agent__create]"
                                                                value="{{$lpvalue['agent__create']}}" id="role_capabilities_agent_create">
                                                    ...
                                                    <div class="role-toggler-wrapper">
                                                        <div class="os-form-group os-form-toggler-group  size-normal">
                                                            <input type="hidden" name="role[capabilities][agent__edit]"
                                                                value="{{$lpvalue['agent__edit']}}" id="role_capabilities_agent_edit">
                                                ...
                                                <div class="role-actions-item">
                                                    ...
                                                    <div class="role-toggler-wrapper">
                                                        <div class="os-form-group os-form-toggler-group  size-normal">
                                                            <input type="hidden" name="role[capabilities][service__view]"
                                                                value="{{$lpvalue['service__view']}}" id="role_capabilities_service_view">
                                                    ...
                                                    <div class="role-toggler-wrapper">
                                                        <div class="os-form-group os-form-toggler-group  size-normal">
                                                            <input type="hidden"
                                                                name="role[capabilities][service__delete]" value="{{$lpvalue['service__delete']}}"
                                                                id="role_capabilities_service_delete">
                                                    ...
                                                    <div class="role-toggler-wrapper">
                                                        <div class="os-form-group os-form-toggler-group  size-normal">
                                                            <input type="hidden"
                                                                name="role[capabilities][service__create]" value="{{$lpvalue['service__create']}}"
                                                                id="role_capabilities_service_create">
                                                    ...
                                                    <div class="role-toggler-wrapper">
                                                        <div class="os-form-group os-form-toggler-group  size-normal">
                                                            <input type="hidden" name="role[capabilities][service__edit]"
                                                                value="{{$lpvalue['service__edit']}}" id="role_capabilities_service_edit">
                                                ...
                                                <div class="role-actions-item">
                                                    ...
                                                    <div class="role-toggler-wrapper">
                                                        <div class="os-form-group os-form-toggler-group  size-normal">
                                                            <input type="hidden"
                                                                name="role[capabilities][location__view]" value="{{$lpvalue['location__view']}}"
                                                                id="role_capabilities_location_view">
                                                    ...
                                                    <div class="role-toggler-wrapper">
                                                        <div class="os-form-group os-form-toggler-group  size-normal">
                                                            <input type="hidden"
                                                                name="role[capabilities][location__delete]" value="{{$lpvalue['location__delete']}}"
                                                                id="role_capabilities_location_delete">
                                                    ...
                                                    <div class="role-toggler-wrapper">
                                                        <div class="os-form-group os-form-toggler-group  size-normal">
                                                            <input type="hidden"
                                                                name="role[capabilities][location__create]" value="{{$lpvalue['location__create']}}"
                                                                id="role_capabilities_location_create">
                                                    ...
                                                    <div class="role-toggler-wrapper">
                                                        <div class="os-form-group os-form-toggler-group  size-normal">
                                                            <input type="hidden"
                                                                name="role[capabilities][location__edit]" value="{{$lpvalue['location__edit']}}"
                                                                id="role_capabilities_location_edit">
                                                ...
                                                <div class="role-actions-item">
                                                    ...
                                                    <div class="role-toggler-wrapper">
                                                        <div class="os-form-group os-form-toggler-group  size-normal">
                                                            <input type="hidden" name="role[capabilities][booking__view]"
                                                                value="{{$lpvalue['booking__view']}}" id="role_capabilities_booking_view">
                                                    ...
                                                    <div class="role-toggler-wrapper">
                                                        <div class="os-form-group os-form-toggler-group  size-normal">
                                                            <input type="hidden"
                                                                name="role[capabilities][booking__delete]" value="{{$lpvalue['booking__delete']}}"
                                                                id="role_capabilities_booking_delete">
                                                    ...
                                                    <div class="role-toggler-wrapper">
                                                        <div class="os-form-group os-form-toggler-group  size-normal">
                                                            <input type="hidden"
                                                                name="role[capabilities][booking__create]" value="{{$lpvalue['booking__create']}}"
                                                                id="role_capabilities_booking_create">
                                                    ...
                                                    <div class="role-toggler-wrapper">
                                                        <div class="os-form-group os-form-toggler-group  size-normal">
                                                            <input type="hidden" name="role[capabilities][booking__edit]"
                                                                value="{{$lpvalue['booking__edit']}}" id="role_capabilities_booking_edit">
                                                ...
                                                <div class="role-actions-item">
                                                    ...
                                                    <div class="role-toggler-wrapper">
                                                        <div class="os-form-group os-form-toggler-group  size-normal">
                                                            <input type="hidden"
                                                                name="role[capabilities][customer__view]" value="{{$lpvalue['customer__view']}}"
                                                                id="role_capabilities_customer_view">
                                                    ...
                                                    <div class="role-toggler-wrapper">
                                                        <div class="os-form-group os-form-toggler-group  size-normal">
                                                            <input type="hidden"
                                                                name="role[capabilities][customer__delete]" value="{{$lpvalue['customer__delete']}}"
                                                                id="role_capabilities_customer_delete">
                                                    ...
                                                    <div class="role-toggler-wrapper">
                                                        <div class="os-form-group os-form-toggler-group  size-normal">
                                                            <input type="hidden"
                                                                name="role[capabilities][customer__create]" value="{{$lpvalue['customer__create']}}"
                                                                id="role_capabilities_customer_create">
                                                    ...
                                                    <div class="role-toggler-wrapper">
                                                        <div class="os-form-group os-form-toggler-group  size-normal">
                                                            <input type="hidden"
                                                                name="role[capabilities][customer__edit]" value="{{$lpvalue['customer__edit']}}"
                                                                id="role_capabilities_customer_edit">
                                                ...
                                                <div class="role-actions-item">
                                                    ...
                                                    <div class="role-toggler-wrapper">
                                                        <div class="os-form-group os-form-toggler-group  size-normal">
                                                            <input type="hidden"
                                                                name="role[capabilities][transaction__view]"
                                                                value="{{$lpvalue['transaction__view']}}" id="role_capabilities_transaction_view">
                                                    ...
                                                    <div class="role-toggler-wrapper">
                                                        <div class="os-form-group os-form-toggler-group  size-normal">
                                                            <input type="hidden"
                                                                name="role[capabilities][transaction__delete]"
                                                                value="{{$lpvalue['transaction__delete']}}" id="role_capabilities_transaction_delete">
                                                    ...
                                                    <div class="role-toggler-wrapper">
                                                        <div class="os-form-group os-form-toggler-group  size-normal">
                                                            <input type="hidden"
                                                                name="role[capabilities][transaction__create]"
                                                                value="{{$lpvalue['transaction__create']}}" id="role_capabilities_transaction_create">
                                                    ...
                                                    <div class="role-toggler-wrapper">
                                                        <div class="os-form-group os-form-toggler-group  size-normal">
                                                            <input type="hidden"
                                                                name="role[capabilities][transaction__edit]"
                                                                value="{{$lpvalue['transaction__edit']}}" id="role_capabilities_transaction_edit">
                                                ...
                                                <div class="role-actions-item">
                                                    ...
                                                    <div class="role-toggler-wrapper">
                                                        <div class="os-form-group os-form-toggler-group  size-normal">
                                                            <input type="hidden"
                                                                name="role[capabilities][activity__view]" value="{{$lpvalue['activity__view']}}"
                                                                id="role_capabilities_activity_view">
                                                    ...
                                                    <div class="role-toggler-wrapper">
                                                        <div class="os-form-group os-form-toggler-group  size-normal">
                                                            <input type="hidden"
                                                                name="role[capabilities][activity__delete]" value="{{$lpvalue['activity__delete']}}"
                                                                id="role_capabilities_activity_delete">
                                                    ...
                                                    <div class="role-toggler-wrapper">
                                                        <div class="os-form-group os-form-toggler-group  size-normal">
                                                            <input type="hidden"
                                                                name="role[capabilities][activity__create]" value="{{$lpvalue['activity__create']}}"
                                                                id="role_capabilities_activity_create">
                                                    ...
                                                    <div class="role-toggler-wrapper">
                                                        <div class="os-form-group os-form-toggler-group  size-normal">
                                                            <input type="hidden"
                                                                name="role[capabilities][activity__edit]" value="{{$lpvalue['activity__edit']}}"
                                                                id="role_capabilities_activity_edit">
                                                ...
                                                <div class="role-actions-item">
                                                    ...
                                                    <div class="role-toggler-wrapper">
                                                        <div class="os-form-group os-form-toggler-group  size-normal">
                                                            <input type="hidden" name="role[capabilities][chat__edit]"
                                                                value="{{$lpvalue['chat__edit']}}" id="role_capabilities_chat_edit">
                                                ...
                                                <div class="role-actions-item">
                                                    ...
                                                    <div class="role-toggler-wrapper">
                                                        <div class="os-form-group os-form-toggler-group  size-normal">
                                                            <input type="hidden"
                                                                name="role[capabilities][settings__edit]" value="{{$lpvalue['settings__edit']}}"
                                                                id="role_capabilities_settings_edit">
                                                ...
                                                <div class="role-actions-item">
                                                    ...
                                                    <div class="role-toggler-wrapper">
                                                        <div class="os-form-group os-form-toggler-group  size-normal">
                                                            <input type="hidden"
                                                                name="role[capabilities][connection__edit]" value="{{$lpvalue['connection__edit']}}"
                                                                id="role_capabilities_connection_edit">
                                                ...
                                                <div class="role-actions-item">
                                                    ...
                                                    <div class="role-toggler-wrapper">
                                                        <div class="os-form-group os-form-toggler-group  size-normal">
                                                            <input type="hidden" name="role[capabilities][coupon__view]"
                                                                value="{{$lpvalue['coupon__view']}}" id="role_capabilities_coupon_view">
                                                    ...
                                                    <div class="role-toggler-wrapper">
                                                        <div class="os-form-group os-form-toggler-group  size-normal">
                                                            <input type="hidden"
                                                                name="role[capabilities][coupon__delete]" value="{{$lpvalue['coupon__delete']}}"
                                                                id="role_capabilities_coupon_delete">
                                                    ...
                                                    <div class="role-toggler-wrapper">
                                                        <div class="os-form-group os-form-toggler-group  size-normal">
                                                            <input type="hidden"
                                                                name="role[capabilities][coupon__create]" value="{{$lpvalue['coupon__create']}}"
                                                                id="role_capabilities_coupon_create">
                                                    ...
                                                    <div class="role-toggler-wrapper">
                                                        <div class="os-form-group os-form-toggler-group  size-normal">
                                                            <input type="hidden" name="role[capabilities][coupon__edit]"
                                                                value="{{$lpvalue['coupon__edit']}}" id="role_capabilities_coupon_edit">
