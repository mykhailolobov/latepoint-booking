                            ...
                            <div class="mb-4">
                                <div id="email_processors_list" class="mb-4">
                                    <div class="os-togglable-items-w">
                                        <input type="hidden" name="settings[notifications_email_processor]" value=""
                                        ...
                                        <div class="os-togglable-item-w" id="notificationProcessorToggler_wp_mail">
                                            <div class="os-togglable-item-head">
                                                <div class="os-toggler-w">
                                                    <input type="radio" name="settings[notifications_email_processor]"
                                                        value="wp_mail" id="settings_notifications_email_processor_wp_mail">
