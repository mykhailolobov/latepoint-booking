    ...
    <div class="row">
        <div class="col-lg-12 col-xxl-12 mb-4 order-3 order-xxl-1">
            <div class="card-header mb-4 d-flex">
                <a href="{{ url('/settings/integrations-calendars') }}"
                    class="agent-status-active text-center mx-2 acitive-tab">
                    <h4 class="m-0 me-2">Calendars</h4>
                </a>
                <a href="{{ url('/settings/integrations-meeting') }}" class="agent-status-active text-center mx-2">
                                                ...
                                                <div class="os-col-12">
                                                    <div
                                                        ...
                                                        <input type="hidden"
                                                            ...
                                                            value="off" id="settings_google_calendar_hide_event_name">
