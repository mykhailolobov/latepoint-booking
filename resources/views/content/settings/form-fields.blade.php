...
@section('content')
    ...
    <div class="latepoint-content ">
        ...
        <div class="os-default-fields" data-route="settings__update_default_fields">
            @if($check == 0)
            <form method="post" class="default_form" action="{{route('settings-storeform-fields')}}" >
                    ...
                    <div class="os-field-setting">
                        <div class="os-form-group os-form-checkbox-group is-checked">
                            <label for="default_fields_first_name_required">
                                <input type="checkbox" name="first_name_required" id="default_fields_first_name_required" class="os-form-checkbox">Required?
                            </label>
                        </div>
                    </div>
                    <div class="os-field-setting">
                    ...
                    <div class="os-field-setting">
                        <div class="os-form-group os-form-checkbox-group is-checked">
                            <label for="default_fields_last_name_required">
                                <input type="checkbox" name="last_name_required" id="default_fields_last_name_required" class="os-form-checkbox">Required?
                            </label>
                        </div>
                    </div>
                    <div class="os-field-setting">
                ...
                <div class="os-default-field ">
                    ...
                    <div class="os-field-setting">
                        <div class="os-form-group os-form-select-group os-form-group-transparent"><select
                                name="email_width" id="default_fields_email_width" class="os-form-control">
                                <option value="os-col-12">Full Width</option>
                                <option value="os-col-6">Half Width</option>
                            </select></div>
                    </div>
                    ...
                    <div class="os-field-setting">
                        <div class="os-form-group os-form-checkbox-group ">
                            <label for="default_fields_phone_required">
                                <input type="checkbox" name="phone_required" id="default_fields_phone_required" class="os-form-checkbox">Required?
                            </label>
                        </div>
                    </div>
                    <div class="os-field-setting">
                        <div class="os-form-group os-form-select-group os-form-group-transparent"><select
                                name="phone_width" id="default_fields_phone_width"
                    ...
                    <div class="os-field-setting">
                        <div class="os-form-group os-form-checkbox-group ">
                            <label for="default_fields_notes_required">
                                <input type="checkbox" name="comments_required" id="default_fields_notes_required" class="os-form-checkbox">Required?
                            </label>
                        </div>
                    </div>
                    <div class="os-field-setting">
            ...
            <form method="post" class="default_form" action="{{route('settings-storeform-fields')}}" >
                ...
                <div class="{{$firstName->class}}" id="first_name_field">
                    <div class="{{ $firstName->class == 'os-default-field' ? 'os-toggler on' : 'os-toggler off' }}" data-for="default_fields_first_name_active">
                        <div class="toggler-rail">
                            <div class="toggler-pill"></div>
                        </div>
                    </div>
                    ...
                    <div class="os-field-setting">
                        <div class="os-form-group os-form-checkbox-group is-checked">
                            <label for="default_fields_first_name_required">
                                <input type="checkbox" name="first_name_required" id="default_fields_first_name_required" class="os-form-checkbox" <?php echo (!empty($firstName->required) && $firstName->required ? 'checked' : ''); ?>>Required?
                            </label>
                        </div>
                    </div>
                    <div class="os-field-setting">
                        <div class="os-form-group os-form-select-group os-form-group-transparent">
                            <select name="first_name_width" id="default_fields_first_name_width" class="os-form-control" onchange="saveWidth()">
                ...
                <div class="{{$lastName->class}}" id="last_name_field">
                    <div class="{{ $lastName->class == 'os-default-field' ? 'os-toggler on' : 'os-toggler off' }}" data-for="default_fields_last_name_active">
                        <div class="toggler-rail">
                            <div class="toggler-pill"></div>
                        </div>
                    </div>
                    ...
                    <div class="os-field-setting">
                        <div class="os-form-group os-form-checkbox-group is-checked">
                            <label for="default_fields_last_name_required">
                                <input type="checkbox" name="last_name_required" id="default_fields_last_name_required" class="os-form-checkbox" <?php echo (!empty($lastName->required) && $lastName->required ? 'checked' : ''); ?>>Required?
                            </label>
                        </div>
                    </div>
                    <div class="os-field-setting">
                        <div class="os-form-group os-form-select-group os-form-group-transparent">
                            <select name="last_name_width" id="default_fields_last_name_width" class="os-form-control" onchange="saveWidth()">
                ...
                <div class="os-default-field">
                    ...
                    <div class="os-field-setting">
                        <div class="os-form-group os-form-select-group os-form-group-transparent"><select
                                name="email_width" id="default_fields_email_width" class="os-form-control" onchange="saveWidth()">
                ...
                <div class="{{$phone->class}}" id="phone_number_field">
                    <div class="{{ $phone->class == 'os-default-field' ? 'os-toggler on' : 'os-toggler off' }}" data-for="default_fields_phone_active">
                        <div class="toggler-rail">
                            <div class="toggler-pill"></div>
                        </div>
                    </div>
                    ...
                    <div class="os-field-setting">
                        <div class="os-form-group os-form-checkbox-group ">
                            <label for="default_fields_phone_required">
                                <input type="checkbox" name="phone_required" id="default_fields_phone_required" class="os-form-checkbox" <?php echo (!empty($phone->required) && $phone->required ? 'checked' : ''); ?>>Required?
                            </label>
                        </div>
                    </div>
                    <div class="os-field-setting">
                        <div class="os-form-group os-form-select-group os-form-group-transparent"><select
                                name="phone_width" id="default_fields_phone_width"
                                class="os-form-control" onchange="saveWidth()">
                ...
                <div class="{{$comments->class}} " id="comments_field">
                    <div class="{{ $comments->class == 'os-default-field' ? 'os-toggler on' : 'os-toggler off' }}" data-for="default_fields_notes_active">
                        <div class="toggler-rail">
                            <div class="toggler-pill"></div>
                        </div>
                    </div> 
                    ...
                    <div class="os-field-setting">
                        <div class="os-form-group os-form-checkbox-group ">
                            <label for="default_fields_notes_required">
                                <input type="checkbox" name="comments_required" id="default_fields_notes_required" class="os-form-checkbox" <?php echo (!empty($comments->required) && $comments->required ? 'checked' : ''); ?>>Required?
                            </label>
                        </div>
                    </div>
                    <div class="os-field-setting">
                        <div class="os-form-group os-form-select-group os-form-group-transparent">
                            <select name="comments_width" id="default_fields_notes_width" class="os-form-control" onchange="saveWidth()">
        ...
        @foreach ($customfields as $item)
              <form method="post" id="create_field" class="create_field os-form-block os-form-block-type-text" action="{{route('settings-updateform-otherfields', $item->id)}}">
                @csrf
                @php
                ...
                <div class="os-form-block-i">
                  ...
                  <div class="os-form-block-params os-form-w">
                    <div class="sub-section-row">
                      ...
                      <div class="sub-section-content">
                        <div class="os-form-group os-form-textfield-group os-form-group-bordered no-label">
                          <input type="text" placeholder="Enter Field Label" name="custom_fields[label]" value="{{$value['label']}}" theme="bordered" class="os-form-block-name-input os-form-control" id="custom_fields_cf_ubxei2ro_label">
                          </div>
                        </div>
                    </div>
                    ...
                    <div class="sub-section-row">
                      ...
                      <div class="sub-section-content">
                        <div class="os-form-group os-form-textfield-group os-form-group-bordered no-label">
                          <input type="text" placeholder="Enter Field Placeholder" name="custom_fields[placeholder]" value="{{$value['placeholder']}}" theme="bordered" id="custom_fields_cf_ubxei2ro_placeholder" class="os-form-control"></div>        </div>
                    </div>
                      ...
                      <div class="sub-section-content">
                        <div class="os-form-group os-form-select-group os-form-group-transparent">
                          <select name="custom_fields[type]" class="os-form-block-type-select os-form-control" id="custom_fields_cf_ubxei2ro_type">
                              <option value="text" <?php echo ($value['type'] == 'text' ? 'selected' : ''); ?>>Text Field</option>
                              <option value="phone_number" <?php echo ($value['type'] == 'phone_number' ? 'selected' : ''); ?>>Phone Number Field</option>
                              <option value="number" <?php echo ($value['type'] == 'number' ? 'selected' : ''); ?>>Number Field</option>
                              <option value="hidden" <?php echo ($value['type'] == 'hidden' ? 'selected' : ''); ?>>Hidden Field</option>
                              <option value="select" <?php echo ($value['type'] == 'select' ? 'selected' : ''); ?>>Select Box</option>
                              <option value="textarea" <?php echo ($value['type'] == 'textarea' ? 'selected' : ''); ?>>Text Area Field</option>
                              <option value="checkbox" <?php echo ($value['type'] == 'checkbox' ? 'selected' : ''); ?>>Checkbox</option>
                              <option value="google_address_autocomplete" <?php echo ($value['type'] == 'google_address_autocomplete' ? 'selected' : ''); ?>>Google Address Autocomplete</option>
                    ...
                    <div class="sub-section-content">
                      <div class="os-form-group os-form-textfield-group os-form-group-bordered no-label">
                          <input type="text" placeholder="Enter Field Default Value" name="custom_fields[value]" value="{{$value['value']}}" theme="bordered" id="custom_fields_cf_ubxei2ro_value" class="os-form-control">
                      </div>
                    </div>
                    </div>
                    ...
                    <div class="sub-section-content">
                      <div class="os-form-group os-form-select-group os-form-group-transparent">
                          <select name="custom_fields[width]" id="custom_fields_cf_ubxei2ro_width" class="os-form-control">
                              ...
                              <option value="os-col-6" <?php echo ($value['width'] == 'os-col-6' ? 'selected' : ''); ?>>Half Width</option>
                          </select>
                      </div>        
                    </div>
                    </div>
                    ...
                    <div class="sub-section-content">
                      <div class="os-form-group os-form-toggler-group  size-normal">
                          <div class="os-toggler <?php echo (!empty($value['required']) ? $value['required'] : 'off'); ?> size-normal" data-is-string-value="true" data-for="custom_fields_cf_ubxei2ro_required">
                              <input type="text" name="custom_fields[required]" value="<?php echo (!empty($value['required']) ? $value['required'] : 'off'); ?>" class="toggle_value" hidden>
                              <div class="toggler-rail">
                                  <div class="toggler-pill"></div>
                              </div>
                          </div>
                    ...
                    <div class="sub-section-content">
                      <div class="os-form-group os-form-toggler-group  size-normal">
                            <div class="os-toggler <?php echo (!empty($value['summary']) ? $value['summary'] : 'off'); ?> size-normal" data-is-string-value="true" data-for="custom_fields_cf_ubxei2ro_hide_on_summary">
                                <input type="text" name="custom_fields[summary]" value="<?php echo (!empty($value['summary']) ? $value['summary'] : 'off'); ?>" class="toggle_value" hidden>
                                <div class="toggler-rail">
                                    <div class="toggler-pill"></div>
                                </div>
                            </div>
    ...
    <script>
        ...
        $('.os-add-box').click(function() {
          $('.os-custom-fields-w').append(`
            <form method="post" id="create_field" class="create_field os-form-block os-form-block-type-text os-is-editing" action="{{route('settings-storeform-otherfields')}}">
              @csrf
              <div class="os-form-block-i">
                <div class="os-form-block-header ">
                  <div class="os-form-block-drag"></div>
        ...
        $('form.default_form').on('submit', function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: "{{ route('settings-storeform-fields') }}",
                headers: {
                ...
                success: function() {
                    console.log('success');
                    window.location.href = "{{ route('settings-form-fields') }}";
                },
                error: function(err) {
                    console.log(err);
                }
