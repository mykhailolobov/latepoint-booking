                    ...
                    <div class="card-body demo-vertical-spacing demo-only-element">
                        <div class="d-flex mb-3">
                            ...
                            <div class="col-lg-5 px-3">
                                <input type="text" class="form-control" name="name" id="defaultFormControlInput" placeholder="Location Name" aria-describedby="defaultFormControlHelp" />
                            </div>
                            <div class="col-lg-7 px-3">
                                <input type="text" class="form-control" name="full_address" id="defaultFormControlInput" placeholder="Location Address" aria-describedby="defaultFormControlHelp" />
                            </div>
                        </div>
                        <div class="d-flex mb-3">
                            <div class="col-lg-5 px-3">
                        ...
                        <div class="d-flex mb-3">
                            <div class="col-lg-5 px-3">
                                ...
                                <div class="d-flex">
                                    <select id="selectpickerBasic" name="category_id" class="selectpicker w-100" data-style="btn-default">
