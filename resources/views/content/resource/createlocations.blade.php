...
<link href="{{asset('/assets/createlocation_custom.css')}}" rel="stylesheet">

<div class="row">
    <div class="col-lg-12 col-xxl-12 mb-4 order-3 order-xxl-1">
        <div class="card-header mb-0">
            <h4 class="m-0 me-2">Create New Location</h4>
            <hr>
        </div>
        <div class="col-md-12">
            <div class="card mb-4">
                ...
                <div class="card-body demo-vertical-spacing demo-only-element">
                    <div class="d-flex mb-3">
                        ...
                        <div class="col-lg-5 px-3">
                            <input type="text" class="form-control" id="defaultFormControlInput" placeholder="Location Name" aria-describedby="defaultFormControlHelp" />
                        </div>
                        <div class="col-lg-7 px-3">
                            <input type="text" class="form-control" id="defaultFormControlInput" placeholder="Location Address" aria-describedby="defaultFormControlHelp" />
                        </div>
                    </div>
                    <div class="d-flex mb-3">
                        <div class="col-lg-5 px-3">
        ...
        <div>
            <button class="btn btn-primary add-location" type="button">Save Location</button>
        </div>
    </div>
</div>
