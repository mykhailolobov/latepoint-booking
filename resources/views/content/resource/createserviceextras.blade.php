...
<link href="{{asset('/assets/createservices_custom.css')}}" rel="stylesheet">
...
<div class="row">
    <div class="col-lg-12 col-xxl-12 mb-4 order-3 order-xxl-1">
                    ...
                    <div class="card-body demo-vertical-spacing demo-only-element">
                        <div class="mb-3">
                            <div class="col-lg-12 px-3 mb-3">
                                ...
                                <input type="text" class="form-control" id="defaultFormControlInput" placeholder="Service Extra Name" aria-describedby="defaultFormControlHelp" />
                            </div>
                            <div class="col-lg-12 d-flex mb-3">
                                <div class="col-lg-4 px-3">
                                    <label for="selectpickerBasic" class="form-label">Duration(minutes)</label>
                                    <input type="text" class="form-control" id="defaultFormControlInput" placeholder="Duration(minutes)" aria-describedby="defaultFormControlHelp" />
                                </div>
                                <div class="col-lg-4 px-3 mb-3">
                                    <label for="selectpickerBasic" class="form-label">Charge Amount</label>
                                    <input type="text" class="form-control" id="defaultFormControlInput" placeholder="$0.00" value="$0.00" aria-describedby="defaultFormControlHelp" />
                                </div>
                                <div class="col-lg-4 px-3 mb-3">
                                    <label for="selectpickerBasic" class="form-label">Maximum Quantity</label>
                                    <input type="text" class="form-control" id="defaultFormControlInput" placeholder="Maximum Quantity" value="1" aria-describedby="defaultFormControlHelp" />
                                </div>
                            </div>
                            <div class="col-lg-12 px-3 mb-3">
        ...
        <div>
            <button class="btn btn-primary add-location" type="button">Add Service Extra</button>
        </div>
    </div>
</div>
