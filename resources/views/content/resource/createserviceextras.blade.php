...
<div class="row">
    <form action="{{route('admin.resource-storeserviceextras')}}" method="post" class="add-serviceExtra">
        @csrf
                            ...
                            <div class="mb-3">
                                ...
                                <div class="col-lg-12 d-flex mb-3">
                                    <div class="col-lg-4 px-3">
                                        ...
                                        <input type="text" name="duration" class="form-control" id="defaultFormControlInput" placeholder="60(minutes)" aria-describedby="defaultFormControlHelp" />
                                    </div>
                                ...
                                <div class="col-lg-12 px-3 mb-3">
                                    ...
                                    <div class="d-flex">
                                        <select id="selectpickerBasic" name="status_extra" class="selectpicker w-100" data-style="btn-default">
    ...
    <div class="d-flex justify-content-between card-header-11">
        ...
        <div class="py-4 px-5">
            <label class="form-check-label custom-option-content selectAll">
                ...
                <div class="col-md-12 mb-md-0 mb-2">
                    <div class="form-check custom-option custom-option-basic">
                        <label class="form-check-label custom-option-content" for="service_extra_{{ $service->id }}">
                            <input class="form-check-input service-checkbox" name="service_extra[{{ $service->slug }}]" type="checkbox" id="service_extra_{{ $service->id }}" checked />
                            <span class="custom-option-header">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        // Check or uncheck all service checkboxes based on Select All checkbox state
        $('.service-checkbox').prop('checked', $(this).prop('checked'));
    });

    // Service checkbox click event
    $('.service-checkbox').click(function() {
        // Uncheck Select All checkbox if any service checkbox is unchecked
    ...
    $('form.add-serviceExtra').on('submit', function(e) {
        ...
        const status = $('select[name="status_extra"]').val();
        ...
        $.ajax({
            type: 'POST',
            url: "{{ route('admin.resource-storeserviceextras') }}",
            headers: {
