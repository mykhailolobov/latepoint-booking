...
<link href="{{asset('/assets/editservices_custom.css')}}" rel="stylesheet">
...
<div class="row">
    <div class="col-lg-12 col-xxl-12 mb-4 order-3 order-xxl-1">
                ...
                <div class="card-body demo-vertical-spacing demo-only-element">
                    <div class="d-flex mb-3">
                        <div class="col-lg-6 px-3">
                            ...
                            <input type="text" class="form-control" id="defaultFormControlInput" placeholder="Service Name" aria-describedby="defaultFormControlHelp" value="Gum Decease" />
                        </div>
                        <div class="col-lg-6 px-3">
                            <label for="selectpickerBasic" class="form-label">Short Description</label>
                            <textarea class="form-control" rows="1">Slowly he whom important. Only we height possible.</textarea>
                        </div>
                    </div>
                    <div class="d-flex mb-3">
                        <div class="col-lg-6 px-3">
                            ...
                            <div class="d-flex">
                                <select id="selectpickerBasic" class="selectpicker w-100" data-style="btn-default">
                                    ...
                                    <option selected>General Dentistry</option>
                    ...
                    <div class="d-flex mb-3">
                        <div class="col-lg-6 px-3">
                            ...
                            <input type="text" class="form-control" id="defaultFormControlInput" value="#E8C634" aria-describedby="defaultFormControlHelp" />
                        </div>
                        <div class="col-lg-6 px-3">
                ...
                <div class="card-body demo-vertical-spacing demo-only-element">
                    <div class="d-flex">
                        ...
                        <div class="col-lg-3 px-3">
                            ...
                            <input type="text" class="form-control" id="defaultFormControlInput" placeholder="" aria-describedby="defaultFormControlHelp" value="$20.00" />
                        </div>
                        <div class="col-lg-3 px-3">
                            <label for="selectpickerBasic" class="form-label">Deposit Amount</label>
                            <input type="text" class="form-control" id="defaultFormControlInput" placeholder="" aria-describedby="defaultFormControlHelp" value="$10.00" />
                        </div>
                    </div>    
                ...
                <div class="card-body demo-vertical-spacing demo-only-element">
                    ...
                    <div class="d-flex">
                        <div class="col-lg-6 px-3">
                            ...
                            <input type="text" class="form-control" id="defaultFormControlInput" placeholder="Minimum Price" aria-describedby="defaultFormControlHelp" value="$20.00" />
                        </div>
                        <div class="col-lg-6 px-3">
                            <label for="selectpickerBasic" class="form-label">Maximum Price</label>
                            <input type="text" class="form-control" id="defaultFormControlInput" placeholder="Maximum Price" aria-describedby="defaultFormControlHelp" value="$40.00" />
                        </div>
                    </div>    
                </div>
            </div>
                ...
                <div class="card-body demo-vertical-spacing demo-only-element">
                    <div class="d-flex">
                        <div class="col-lg-3 px-3">
                            ...
                            <input type="text" class="form-control" id="defaultFormControlInput" placeholder="Buffer Before" aria-describedby="defaultFormControlHelp" value="10 minutes" />
                        </div>
                        <div class="col-lg-3 px-3">
                            <label for="selectpickerBasic" class="form-label">Buffer After</label>
                            <input type="text" class="form-control" id="defaultFormControlInput" placeholder="Buffer After" aria-describedby="defaultFormControlHelp" value="10 minutes" />
                        </div>
                        <div class="col-lg-3 px-3">
                        ...
                        <div class="col-lg-3 px-3">
                            ...
                            <select id="selectpickerBasic" class="selectpicker w-100" data-style="btn-default">
                                <option>Use from general settings</option>
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-md-0 mb-2">
                            <div class="form-check custom-option custom-option-basic">
                                <label class="form-check-label custom-option-content" for="agent1">
                                    <input class="form-check-input" type="checkbox" value="" id="agent1" checked />
                                    <span class="custom-option-header">
                        ...
                        <div class="col-md-12">
                            <div class="form-check custom-option custom-option-basic">
                                <label class="form-check-label custom-option-content" for="agent2">
                                    <input class="form-check-input" type="checkbox" value="" id="agent2" checked />
                                    <span class="custom-option-header">
                        ...
                        <div class="col-md-12 mb-md-0 mb-2">
                            <div class="form-check custom-option custom-option-basic">
                                <label class="form-check-label custom-option-content" for="agent3">
                                    <input class="form-check-input" type="checkbox" value="" id="agent3" checked />
                                    <span class="custom-option-header">
                        ...
                        <div class="col-md-12">
                            <div class="form-check custom-option custom-option-basic">
                                <label class="form-check-label custom-option-content" for="agent4">
                                    <input class="form-check-input" type="checkbox" value="" id="agent4" checked />
                                    <span class="custom-option-header">
                        ...
                        <div class="col-md-12 mb-md-0 mb-2">
                            <div class="form-check custom-option custom-option-basic">
                                <label class="form-check-label custom-option-content" for="agent5">
                                    <input class="form-check-input" type="checkbox" value="" id="agent5" checked />
                                    <span class="custom-option-header">
                        ...
                        <div class="col-md-12">
                            <div class="form-check custom-option custom-option-basic">
                                <label class="form-check-label custom-option-content" for="agent6">
                                    <input class="form-check-input" type="checkbox" value="" id="agent6" checked />
                                    <span class="custom-option-header">
        ...
        <div class="col-md-12">
            <div class="card mb-4">
                ...
                <div class="card-body demo-vertical-spacing demo-only-element">
                    <div class="mb-3 col-lg-12 px-3 first_section">
                        <div class="latepoint-message latepoint-message-subtle">
                            Service shares custom daily schedules that you set in general settings for your company, however you can add additional days with custom hours which will be specific to this service only.
                        </div>
                    </div>
        ...
        <div class="col-md-12">
            <div class="card mb-4">
                ...
                <div class="card-body demo-vertical-spacing demo-only-element">
                    <div class="mb-3 col-lg-12 px-3 first_section">
                        <div class="latepoint-message latepoint-message-subtle">
                            Service uses the same holidays you set in general settings for your company, however you can add additional holidays for this service here.
                        </div>
                    </div>
                    <div class="custom-day-work-periods px-3">
                        <div class="custom-day-work-period">
        ...
        <div>
            <button class="btn btn-primary add-service" type="button">Save Changes</button>
            <button class="btn btn-danger delete-service" type="button">Delete Service</button>
        </div>
    </div>
</div>
