                    ...
                    <div class="card-body demo-vertical-spacing demo-only-element">
                        ...
                        <div class="d-flex mb-3">
                            ...
                            <div class="col-lg-4 px-3">
                                <input type="text" class="form-control" id="defaultFormControlInput" placeholder="First Name" aria-describedby="defaultFormControlHelp" name="first_name" value="{{$agent->first_name}}"/>
                            </div>
                            <div class="col-lg-4 px-3">
                                <input type="text" class="form-control" id="defaultFormControlInput" placeholder="Last Name" aria-describedby="defaultFormControlHelp" name="last_name" value="{{$agent->last_name}}"/>
                            </div>
                            <div class="col-lg-4 px-3">
                                <input type="text" class="form-control" id="defaultFormControlInput" placeholder="Display Name" aria-describedby="defaultFormControlHelp" name="display_name" value="{{$agent->display_name}}"/>
                            </div>
                        </div>
                        <div class="d-flex mb-3">
                            <div class="col-lg-4 px-3">
                                <input type="email" class="form-control" id="defaultFormControlInput" placeholder="Email Address" aria-describedby="defaultFormControlHelp" name="email" value="{{$agent->email}}"/>
                            </div>
                            <div class="col-lg-4 px-3">
                                <input type="text" class="form-control" id="defaultFormControlInput" placeholder="Phone Number" aria-describedby="defaultFormControlHelp" name="phone" value="{{$agent->phone}}"/>
                            </div>
                        </div>    
                        <div class="d-flex mb-3">
                            <div class="col-lg-4 px-3">
                            ...
                            <div class="col-lg-4 px-3">
                                ...
                                <select id="selectpickerBasic" class="selectpicker w-100" data-style="btn-default" name="status" value="{{$agent->status}}">
                    ...
                    <div class="card-body demo-vertical-spacing demo-only-element">
                        ...
                        <div class="d-flex">
                            <div class="col-lg-6 px-3">
                                <input type="email" class="form-control" id="defaultFormControlInput" placeholder="Additional Email Addresses" aria-describedby="defaultFormControlHelp" name="extra_email" value="{{$agent->extra_emails}}"/>
                            </div>
                            <div class="col-lg-6 px-3">
                                <input type="text" class="form-control" id="defaultFormControlInput" placeholder="Additional Phone Numbers" aria-describedby="defaultFormControlHelp" name="extra_phone" value="{{$agent->extra_phones}}"/>
                            </div>
                        </div>    
                    </div>
                </div>
                    ...
                    <div class="card-body demo-vertical-spacing demo-only-element">
                        <div class="mb-3 px-3">
                            ...
                            <div class="col-lg-12 mb-4">
                                <input type="text" class="form-control" id="defaultFormControlInput" placeholder="Agent Title" aria-describedby="defaultFormControlHelp" name="title" value="{{$agent->title}}"/>
                            </div>
                            <div class="col-lg-12">
